...
var TOOLS = [
  ...
  {type:'function',function:{name:'consult_advisor',description:'Route a question or substantial task through the HAM\'s real born advisor department and return that advisor\'s committed brief. '
    ...
    +'Pass the best-fit public name, alias, or station slug. The handler uses the runtime's canonical resolver when present, then validates against the born per-HAM roster; never invent a seat. The selected advisor may convene its real specialists and advisor council, then A\'NU voices the coherent result.',
